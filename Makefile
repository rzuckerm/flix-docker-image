FLIX_VERSION := $(shell cat FLIX_VERSION)
FLIX_DEPS := $(wildcard FLIX_*)
DOCKER_TAG_PREFIX := rzuckerm/flix:$(FLIX_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(FLIX_DEPS)
